...
- [`set_workspace_domain`](/claude-connector/tools-reference) — set the workspace-wide domain via Claude
- [`check_workspace_domain`](/claude-connector/tools-reference) — see current status from Claude
- [`remove_workspace_domain`](/claude-connector/tools-reference) — unlink the domain from Claude
