...
title: Brand Voice
description: >-
  The commercial foundation of your workspace — the expertise, positioning, and
  guardrails that make every product feel like you.
---
...
Your core positioning statement in one sentence. This is used as the base promise across your products' written results and advisor responses. Be specific about the outcome you deliver, not the service category.
...
**CTA button text** — the label that appears on the call-to-action button in commercial outputs. This becomes the fallback CTA across outcomes that do not override it at the node level.
