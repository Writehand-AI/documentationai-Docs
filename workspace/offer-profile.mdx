...
Your Brand Voice does not override node-level settings. If a specific Report node has its own CTA configured, that takes precedence. Brand Voice is the fallback layer that ensures consistency across everything you build.
