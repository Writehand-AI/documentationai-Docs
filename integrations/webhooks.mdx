...
title: Webhooks
description: >-
  Send real-time data from your AI product to any external system the moment a
...
<Steps>
  ...
  <Step title="Save and publish" title-type="p">
...
If you're connecting to a CRM or email platform, Zapier is often the easiest path — it handles the field mapping visually without any code. See the Zapier integration guide for step-by-step instructions.
...
- Trigger a booking confirmation flow when someone completes a product
