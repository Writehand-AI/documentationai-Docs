---
title: All tools
description: The full set of 73 tools the Claude Connector exposes, organised by category.
---
...
<Columns cols="2">
  ...
  <Card title="add_node" icon="plus-circle">
    Add a node to the canvas (gpt, doc_builder, dynamic_output_page, advisor_chat) and wire it into the flow.
  </Card>
  <Card title="add_mcp_connection" icon="plug">
  ...
  <Card title="update_mcp_connection" icon="refresh-cw">
...
<Columns cols="2">
  ...
  <Card title="get_landing_page_template" icon="layout">
...
<Columns cols="2">
  ...
  <Card title="set_custom_branding" icon="badge">
