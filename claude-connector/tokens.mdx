...
<Callout kind="tip">You rarely have to think about this by hand: the Page node's canvas panel detects same-named fields across nodes and offers the node-qualified token for you automatically. See [The canvas panel](/canvas/page-node#the-canvas-panel).</Callout>
