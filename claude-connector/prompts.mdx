...
Prompts are an additional access surface alongside the [80 tools](/claude-connector/tools-reference) — they don't replace anything, they just make common flows easier to discover and faster to invoke.
