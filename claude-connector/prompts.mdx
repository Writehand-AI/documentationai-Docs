...
Prompts are an additional access surface alongside the [64 tools](/claude-connector/tools-reference) — they don't replace anything, they just make common flows easier to discover and faster to invoke.
...
<Columns cols="2">
  ...
  <Card title="view_result_designs" icon="grid">
    **Show the result-page designs**
    Gallery of the 5 scorecard result designs (Score, Dimensions, Radar, Persona, Deep Insights) with previews.
  </Card>
