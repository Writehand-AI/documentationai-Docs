...
**Triggers:** `plan_product` → `create_product` → `generate_product({ outcome: "design" })` → `apply_result_template({ template_id: "radar" })`
...
**Triggers:** `plan_product` → `create_product` → `generate_product({ outcome: "design" })` → `apply_result_template({ template_id: "insights" })`
**Returns:** Demo URL.
...
**Triggers:** `apply_result_template({ template_id: "dimensions" })`
**Returns:** Demo URL.
...
**Triggers:** `get_latest_plan` (or read the idea via `brain_ask`) → `plan_product` → `create_product` → `generate_product` → `apply_result_template`
...
**Triggers:** `set_webhook` → `get_webhook` (confirm)
