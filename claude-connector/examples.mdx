...
## Set a product's language

> *"Set the language of my Teppich-Design-Guide to German."*

**Triggers:** `update_node` (sets `language` on the product's AI Product node)
**Returns:** Confirmation. The conversation, the AI Agents' analysis and the result page all switch to that language. It's the same setting as **Collection Instructions → Language** on the canvas.
