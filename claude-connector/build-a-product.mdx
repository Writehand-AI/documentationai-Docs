...
<Steps>
  ...
  <Step title="apply_result_template — design output">
    For **design** outcomes, Claude calls `apply_result_template` with one of six branded presets (Dimensions, Radar, Persona, Deep Insights, Grid, Narrative Report). This sets the page HTML *and* configures the AI agent to output the exact field names the page expects.
