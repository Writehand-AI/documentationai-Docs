...
When you add the connector in Claude, Claude opens a Productised sign-in popup. You sign in (or are recognised if already signed in to <https://app.productised.ai>), click **Authorise**, and Claude receives a scoped access token.
