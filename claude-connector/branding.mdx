...
<Columns cols="2">
  <Card title="Fonts via update_branding" icon="type">
    Switch the typeface used across a product's chat interface with `update_branding` (its `font` option) — 15 choices including Inter, Poppins, Space Grotesk, Oxanium and Montserrat. Every `apply_theme` preset also carries its own font.
  </Card>
