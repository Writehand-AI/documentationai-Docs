...
<Callout kind="info">
**Don't have a Productised account yet?** Sign up first at [app.productised.ai/signup](https://app.productised.ai/signup). It takes 30 seconds — you just need an email. Then come back here to connect Claude.
</Callout>
