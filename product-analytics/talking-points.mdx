...
description: >-
  Turn your response data into presentation-ready audience intelligence for
  webinars, keynotes, workshops, and podcasts.
---
**Pro feature.** Talking Points is available on Pro plans and above.
...
Use the **Copy all** button to get the full output as plain text — ready to paste into your slide notes, speaker doc, or presentation prep workflow.
