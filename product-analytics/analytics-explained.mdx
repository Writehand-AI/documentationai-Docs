...
If you don't have BYOK, the footer suggests it: _"this product would cost you \~$0.84 this month direct to Anthropic"_ — a real number from your own usage, not an estimate. Click through to **Settings → Secrets** to add a key.
