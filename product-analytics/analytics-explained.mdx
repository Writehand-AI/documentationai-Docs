...
<Callout kind="tip">The "real $" figure is what you would pay Anthropic directly for the same tokens. Productised's plan-credit pricing includes platform infrastructure and support; the gap between the two is your platform fee.</Callout>
