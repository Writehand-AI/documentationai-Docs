...
title: Brain Sources
description: >-
  Upload your methodology, frameworks, and positioning documents to give Brain
  deep, permanent knowledge of how you think and work. Consider the Productised
  brain as our built-in response to Claude - where you upload all information,
  give the AI context, and each session it remembers. 


  If you would rather do that with Claude instead, use the Claude Connector to
  create, edit, and deploy AI products instead.
---
...
<Steps>
  <Step title="Open the Sources tab" title-type="p">
    In the Brain left panel, select the **Sources** tab.
  </Step>

  <Step title="Upload a file or add a URL" title-type="p">
  ...
  <Step title="Wait for indexing" title-type="p">
