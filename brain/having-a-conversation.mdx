...
When Brain has enough context to make a confident, specific recommendation, it generates a BUILD\_THIS card inline in the conversation. This isn't a vague suggestion — it's a complete concept: a product name, an output type (Standard, Page, Advisor, Collect only), and a funnel stage.
