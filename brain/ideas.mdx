---
title: Product ideas
description: Your Brain-curated product backlog — concepts surfaced through strategic conversations and ready to build the moment you are.
---
...
<Callout kind="tip">If you have an idea you want to sharpen before building, take it back to Brain. Paste the concept into a conversation and ask Brain to help you refine the name, positioning, funnel placement, or output type. Brain can stress-test an idea as readily as it can generate one — and a refined concept often becomes a significantly better product.</Callout>
