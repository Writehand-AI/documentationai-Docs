...
description: >-
  How your AI product evaluates each person — and how that evaluation shapes the
...
Without a decision model, the AI produces an outcome that is informed by the conversation but not structured around a conclusion. With a decision model active, every outcome — Standard, Page, Advisor — is shaped by the AI's specific determination of who this person is and what they need.
