...
The **Advisor Chat** node is a conversational outcome. Where a Report or Document delivers a static, formatted result, the Advisor Chat delivers something different: an interactive, contextualised advisory session where the AI draws on everything it collected during the conversation to open a personalised exchange.
