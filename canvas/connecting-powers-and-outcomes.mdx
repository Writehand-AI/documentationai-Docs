...
<Steps>
  <Step title="Find the node you want" title-type="p">
    Hover over each item in the toolbar to see a tooltip explaining what it does.
  </Step>

  <Step title="Drag it onto the canvas" title-type="p">
  ...
  <Step title="Configure it" title-type="p">
...
<Callout kind="tip" collapsed="false">
  Webhooks are not a canvas node — they're configured in the product's Webhook settings. Everything the AI knows about your business comes from the prompt in the AI Product node's Collection Instructions.
</Callout>
